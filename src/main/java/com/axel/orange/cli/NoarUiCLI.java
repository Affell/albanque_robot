...
public class NoarUiCLI {
     ...
     * Java sample:
     * > cd target\classes
     * > java -cp . com.axel.orange.NoarUiCLI -h
     * 
     * Maven sample:
     * > mvn exec:java -Dexec.mainClass="com.axel.orange.cli.NoarUiCLI" -Dexec.args="-h"
     * 
     * @param args
    ...
    public static void main(String[] args) {
        ...
        if ("1".equals(feature)) {
            ...
            application.add(applicationName, url, NoraRobotContext.class, "NoraRobot", verbose);
        } else if ("2".equals(feature)) {
            Scenario scenario = new Scenario();
            scenario.add(scenarioName, description, applicationName, "NoraRobot", verbose);
        }
