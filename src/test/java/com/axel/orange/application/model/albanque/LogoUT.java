...
* NoraRobot is licensed under the licence BSD.
*
* CAUTION: NoraRobot use NoraUi library. This project is licensed under the licence GNU AFFERO GENERAL PUBLIC LICENSE
*/
package com.axel.orange.application.model.albanque;
